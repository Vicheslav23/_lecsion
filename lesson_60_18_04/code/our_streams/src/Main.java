...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        IntStream intStream = IntStream.range(1,3); // диапазон (range)
        // генерирует поток с шагом 1 упорядоченных элементов от
...
//        names.forEach(s-> System.out.println(s)); // терминальная операция (forEach)
